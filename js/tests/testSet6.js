...
define(['tests/tools', 'tests/data', 'application/main'], function (tools, data, main) {
    ...
    var url = "appid=2ce4b44409a94f81a890881205c30393&ex=-9279312,5238092,-9259324,5256972,102100",
    ...
    $.aop.before({
        ...
        tools.showStatus(1, config.ex === "-9279312,5238092,-9259324,5256972,102100", "startup ex param");
