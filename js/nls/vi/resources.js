...
define(
    ({
        ...
        messages: {
            ...
            noSearchLayerConfigured: "Không có lớp tìm kiếm nào được cấu hình",  // Appears before a list of map layers; shown when the app is not configured with any layers to use for the find command; works with the mapLayers prompt
            ...
            searchLayerNotSearchable: "Không thể tìm thấy các trường cho lớp bản đồ.<br><br>Xác nhận rằng lớp này tồn tại ở thư mục gốc của Nội dung bản đồ. Dịch vụ lồng nhau, chẳng hạn như dịch vụ bản đồ năng động ArcGIS for Server phải được thêm vào một lớp bản đồ tại một thời điểm (bao gồm cả số chỉ số lớp) được sử dụng để Tìm Lớp. Không thể sử dụng dịch vụ Tiled để Tìm Lớp.",
